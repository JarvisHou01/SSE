...
//        String tempPathForIndex = System.getProperty("user.home") + "\\tempforindex\\"+indexFile.getOriginalFilename();
//        System.out.println(tempPathForIndex);

//        FileUtils.write(tempPathForIndex,indexFile.getInputStream());

//        indexFile.transferTo(new File(tempPathForIndex));


        BufferedReader reader = new BufferedReader(new InputStreamReader(indexFile.getInputStream()));

        String path = "C:\\Users\\HJW\\tempforindex\\eng_test_long_index.qducodedindex";
//        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(tempPathForIndex)));
